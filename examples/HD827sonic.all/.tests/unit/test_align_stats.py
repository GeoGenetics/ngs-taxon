...
def test_align_stats(conda_prefix):

    with tempfile.TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        config_path = Path(".tests/unit/align_stats/config")
        data_path = Path(".tests/unit/align_stats/data")
        expected_path = Path(".tests/unit/align_stats/expected")
