...
def test_metadmg_damage(conda_prefix):

    with tempfile.TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        config_path = Path(".tests/unit/metadmg_damage/config")
        data_path = Path(".tests/unit/metadmg_damage/data")
        expected_path = Path(".tests/unit/metadmg_damage/expected")
