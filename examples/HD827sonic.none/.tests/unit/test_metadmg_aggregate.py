...
def test_metadmg_aggregate(conda_prefix):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        config_path = Path(".tests/unit/metadmg_aggregate/config")
        data_path = Path(".tests/unit/metadmg_aggregate/data")
        expected_path = Path(".tests/unit/metadmg_aggregate/expected")
