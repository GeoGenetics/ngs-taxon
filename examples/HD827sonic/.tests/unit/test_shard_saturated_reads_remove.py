...
def test_shard_saturated_reads_remove(conda_prefix):

    with tempfile.TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        config_path = Path(".tests/unit/shard_saturated_reads_remove/config")
        data_path = Path(".tests/unit/shard_saturated_reads_remove/data")
        expected_path = Path(".tests/unit/shard_saturated_reads_remove/expected")
