...
if config["align"]["mark_duplicates"]["tool"] == "bamsormadup":
    rule bamsormadup:
        ...
        output:
            bam = temp("temp/align/mark_duplicates/{sample}_{library}_{read_type_map}.{ref}.{n_chunk}-of-{tot_chunks}.bam"),
            index = temp("temp/align/mark_duplicates/{sample}_{library}_{read_type_map}.{ref}.{n_chunk}-of-{tot_chunks}.bam.bai"),
            metrics = "stats/align/mark_duplicates/{sample}_{library}_{read_type_map}.{ref}.{n_chunk}-of-{tot_chunks}.metrics.txt",
        log:
            "logs/align/mark_duplicates/{sample}_{library}_{read_type_map}.{ref}.{n_chunk}-of-{tot_chunks}.log"
        benchmark:
            "benchmarks/align/mark_duplicates/{sample}_{library}_{read_type_map}.{ref}.{n_chunk}-of-{tot_chunks}.jsonl"
        params:
    ...
    rule markdup:
        ...
        output:
            bam = temp("temp/align/mark_duplicates/{sample}_{library}_{read_type_map}.{ref}.{n_chunk}-of-{tot_chunks}.bam"),
            idx = temp("temp/align/mark_duplicates/{sample}_{library}_{read_type_map}.{ref}.{n_chunk}-of-{tot_chunks}.bam.csi"),
            metrics = "stats/align/mark_duplicates/{sample}_{library}_{read_type_map}.{ref}.{n_chunk}-of-{tot_chunks}.metrics.txt",
        log:
            "logs/align/mark_duplicates/{sample}_{library}_{read_type_map}.{ref}.{n_chunk}-of-{tot_chunks}.log"
        benchmark:
    ...
    rule markduplicates:
        ...
        output:
            bam = temp("temp/align/mark_duplicates/{sample}_{library}_{read_type_map}.{ref}.{n_chunk}-of-{tot_chunks}.bam"),
            idx = temp("temp/align/mark_duplicates/{sample}_{library}_{read_type_map}.{ref}.{n_chunk}-of-{tot_chunks}.bam.bai"),
            metrics = "stats/align/mark_duplicates/{sample}_{library}_{read_type_map}.{ref}.{n_chunk}-of-{tot_chunks}.metrics.txt",
        log:
            "logs/align/mark_duplicates/{sample}_{library}_{read_type_map}.{ref}.{n_chunk}-of-{tot_chunks}.log"
        benchmark:
    ...
    rule markduplicateswithmatecigar:
        input:
            bams = lambda w: get_chunk_aln(w, "mark_duplicates"),
        output:
            bam = temp("temp/align/mark_duplicates/{sample}_{library}_{read_type_map}.{ref}.{n_chunk}-of-{tot_chunks}.bam"),
